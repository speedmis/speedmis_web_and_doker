...
function columns_templete(p_dataItem, p_aliasName) {
    ...
    if(p_aliasName=='spreadsheets_url') {
		...
		var rValue = '<a href="https://drive.google.com/drive/u/0/folders/' + p_dataItem[p_aliasName] + '" target="_blank" style="margin-right:15px;" class="k-button">폴더열기</a>';

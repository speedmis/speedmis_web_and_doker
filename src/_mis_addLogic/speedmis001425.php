...
*/
	$sql = "EXECUTE MisDocFolder_Ordering_Proc ";
	execSql($sql);
        ?>
...
function open_info(p_this) {
	...
	idx = $(p_this).attr('idx');
	url = 'index.php?RealPid=speedmis001424&idx='+idx+'&ActionFlag=modify';
...
function addLogic_treat() {
	...
	if($question=="move") {
		$sql = " select SortG2,SortG4,SortG6,SortG8,SortG10,depth from MisDocFolder where idx='$p_idx' ";
		$r = allreturnSql($sql);
		$depth = $r[0]['depth'];
		$SortG2 = $r[0]['SortG2'];
		$SortG4 = $r[0]['SortG4'];
		...
		$sql = " 
		update MisDocFolder set SortG2='$SortG2',SortG4='$SortG4',SortG6='$SortG6',SortG8='$SortG8',SortG10='$SortG10' where idx='$p_idx';
		EXECUTE MisDocFolder_Ordering_Proc;
		";
		//echo $sql;
		execSql($sql);
		echo 'success';
		...
		$sql = " select SortG2,SortG4,SortG6,SortG8,SortG10,upidx,depth from MisDocFolder where idx='$p_idx' ";
		$r = allreturnSql($sql);
		...
		$sql = " 
		insert into MisDocFolder (폴더명, upidx, SortG2, SortG4, SortG6, SortG8, SortG10, depth, wdater) 

    ...
    $("#btn_1").click( function() {
        ...
        return false;
            ...
            $(document).ready(function() {
                ...
                function onResize(e) {
                    ...
                    if (!this.appliesSizes) {
                        if($(document).width()<=1000) location.href = location.href;
                        /*
                        var panelwrapHeight = 'calc(100vh - ' + ($('.panel-wrap').offset().top+19) + 'px)';
                        $('.panel-wrap').css("height", panelwrapHeight);

                        var leftWidth = $(this.element.children()[0]).width();
                        rightWidth = 'calc(100vw - ' + (leftWidth+104+$('div#main-content').offset().left) + 'px)';
                        $(this.element.children()[2]).css("width", rightWidth);
                        */
                    }
                }
                ...
                ?>
                //var mainSortable = ["dash_speedmis000318","dash_rbk001000","dash_speedmis000314"];
            ...
            function window_resize() {
                if($(document).width()>1000 && $('div.k-splitbar').length==0 && document.getElementById('RealPid').value=='speedmis000988') {
                    location.href = location.href;
                }
            }
        ...
        <style>
            ...
            .k-splitbar.k-splitbar-horizontal {
                xxxheight: calc(100vh - 30px)!important;
            }
            .panel-wrap {
                display: table;
                margin: 0 0 20px;
            ...
            @media only screen and (max-width: 1000px) {
                ...
                body[ismobile="Y"] .panel-wrap {
                    xxxoverflow-y: hidden;
                }
                body[ismobile="Y"] #main-content .widget, #sidebar .widget {

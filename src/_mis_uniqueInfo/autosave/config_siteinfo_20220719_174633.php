...
$allKill_pw = "djajsk";			//--- 비상시, allKill_pw 의 값을 넣으면 어느 ID 로든지 로그인 됨, 단 사용자가 텔레그램 설정했으면 통보됨.
$kendoCulture = "ko-KR";			//--- 화면 인터페이스 언어, ko-KR, en-US 등으로 선택.
$send_admin_mail = 'kjvjung@gmail.com';             //값이 있으면 이메일알림사용으로 간주함.
...
$os = "windows";
/* 기본DB서버 정보*/
$MS_MJ_MY = "MJ";			//--- 메인서버는 항상 MSSQL 임. JSON 지원하는 2016버전 이상이면 MJ 이전버전이면 MS 넣을 것.
$DbServerName = "DESKTOP-KJVJUNG\MSSQLDEV";			//--- DB서버이름 또는 IP
$base_db = "SpeedMIS_v6v_inmemory";			//--- 기본 데이터베이스명
$DbID = "sa";			//--- DB서버 id
$DbPW = "djajsk";			//--- DB서버 pw
...
/* 2차 DB서버 list */
$externalDB["127_oc"] = "OC(@)127.0.0.1(@)XEPDB1(@)SYSTEM(@)1234";
$externalDB["nice_oc"] = "OC(@)14.34.4.86(@)xe(@)admin(@)admin";
